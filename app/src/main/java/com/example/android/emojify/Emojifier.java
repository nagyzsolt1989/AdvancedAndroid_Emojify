...
class Emojifier {
    ...
    public static void getClassifications(Face face){
        Log.d(TAG, "left eye: "+face.getIsLeftEyeOpenProbability());
        Log.d(TAG, "right eye: "+face.getIsRightEyeOpenProbability());
        Log.d(TAG, "smiling: "+face.getIsSmilingProbability());
    }
}
